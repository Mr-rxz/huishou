...
public class CheckUtil {
	private static final String token = "rxz";
	public static boolean checkSignstate(String signtate , String timestamp, String nonce){
		...
		//sha1加密
		String temp = Digest(content.toString()).toLowerCase();
		
		
		return temp.equals(signtate);
	}
